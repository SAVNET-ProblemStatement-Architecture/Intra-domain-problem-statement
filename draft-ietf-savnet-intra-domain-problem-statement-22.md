...
This document provides a gap analysis of the current operational intra-domain SAV mechanisms and identifies minimum requirements for any new intra-domain SAV solutions.
...
This section identifies five requirements to guide the design, development, and evaluation of new intra-domain SAV mechanisms, and to provide a common basis for improving upon existing approaches. These requirements are informational in nature. They are intended to avoid misinterpretation or misuse as normative constraints for initiating standards-track protocol specifications.
...
Any new intra-domain SAV mechanism MUST use information that is trusted, either through verification of its authenticity and trustworthiness or through an established trust relationship with the information source. If a SAV mechanism introduces SAV-specific information, such information MUST be authenticated to ensure its integrity and correctness before being used for SAV decision making.
